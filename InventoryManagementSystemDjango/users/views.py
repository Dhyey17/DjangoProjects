...
class Users(APIView):
    ...
    def get(self, request, id=None):
        if id is None:
            ...
            return success_response(data=data, msg="Sellers fetched", status_code=status.HTTP_200_OK)
    ...
    def patch(self, request, id):
        ...
        if seller_from_token.id != id:
            return error_response(msg="Forbidden",
        ...
        seller.save()
        return success_response(msg="Seller updated",
                                status_code=status.HTTP_200_OK)
    ...
    def delete(self, request, id):
        ...
        seller.delete()
        return success_response(msg="Seller deleted",
